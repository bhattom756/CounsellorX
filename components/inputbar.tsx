    ...
    <div className="w-[min(920px,92%)]">
      ...
      <div className="main-container p-4">
        ...
        <div className="flex gap-2.5 mt-12">
          <Button variant="outline" className="bg-white text-gray-800 border-gray-200">DeepThink</Button>
          <Button variant="outline" className="bg-white text-gray-800 border-gray-200">Search</Button>
          <div className="ml-auto flex items-center gap-2.5">
            <Button variant="ghost" className="bg-white text-gray-800" aria-label="Attach"><Paperclip size={18} /></Button>
